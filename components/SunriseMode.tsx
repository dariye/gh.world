  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className={`flex items-center gap-1 sm:gap-1 md:gap-1.5 px-2 sm:px-2.5 md:px-3 py-1 sm:py-1 md:py-1.5 rounded-full text-xs font-medium transition-all shrink-0 ${
          isActive
