            ...
            <DialogContent className="bg-zinc-950 border-zinc-800 p-0 gap-0 max-w-md sm:max-w-lg">
                {selectedUsername && profileStats ? (
                    ...
                    <div className="p-4">
                        <button
                            onClick={handleBack}
                            className="text-sm text-zinc-400 hover:text-zinc-200 mb-4 flex items-center gap-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background rounded-md px-1"
                        >
                            ← Back to search
                        </button>
                    ...
                    <>
                        ...
                        <div className="flex border-b border-zinc-800">
                            <button
                                ...
                                className={`flex-1 py-2 px-4 text-sm font-medium transition-colors flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset ${
                                    searchMode === "username"
